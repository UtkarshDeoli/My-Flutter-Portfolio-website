...
Color kGradient1 = const Color(0xffff758c);
Color kGradient2 = const Color(0xffff7eb3);
...
String GithubLink = "https://github.com/utkarshdeoli";
//Contact Email
...
My love for DIY electronics led me to explore freelance opportunities on platforms like Fiverr as an Arduino Developer. And as I progressed further, I realized that my projects needed a more user-friendly interface. This led me to delve into the world of mobile app development, where I picked up Flutter as a means to turn my ideas into reality.

Currently, I am constantly learning and honing my skills in Flutter to bring my dreams to life. Through my passion for DIY electronics and mobile app development, I hope to make a difference in the world and contribute to building a better tomorrow.
''';

String location = "Dehradun,UK,India";
String website = "utkarsh-deoli.web.app";
